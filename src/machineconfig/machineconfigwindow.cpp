                                         ...
                                         QWidget *parent) : QWidget(parent)
{
    ...
    m_optionsListWidget->addItem(tr("Cloud-init"));
    m_optionsListWidget->item(8)->setIcon(QIcon::fromTheme("cloud",
                                                           QIcon(QPixmap(":/images/icons/breeze/32x32/computer.svg"))));

    /*m_optionsListWidget->addItem(tr("Display"));
    m_optionsListWidget->item(9)->setIcon(QIcon::fromTheme("applications-multimedia",
    ...
    m_optionsStackedWidget->addWidget(this->m_configCloudInit->m_cloudInitPageWidget);
...
void MachineConfigWindow::saveMachineSettings()
{
    ...
    this->m_configCloudInit->saveCloudInitData();
